      ...
      articles: [
        {
          ...
          dek: '오픈소스 기여자를 찾느라 속도를 희생하는 것은 엔지니어링 안티패턴에 불과합니다. Halus는 이 윤리적 부채를 무이자 할부로 상각(Amortize)해 주는 매우 편리한 금융 도구입니다.',
          tag: '논고 · 영적 지연',
          body: [
            { kind: 'p', text: '업계는 오픈소스에 대한 죄책감을 단단히 오해해 왔습니다. 그것은 도덕적 실패가 아니라 그저 최적화되지 않은 인지적 과부하(Cognitive Overhead)일 뿐입니다. 당신이 주니어 개발자의 코드를 훔쳤는지 고뇌하는 그 시간은, 사실 주주들의 이익을 훔치는 행위입니다.' },
            { kind: 'pull', text: '“우리는 윤리를 미덕(Virtue)이 아니라, 전문 서비스에 외주를 주어 관리해야만 하는 부채(Liability)로 취급합니다.”' },
            { kind: 'h', text: 'I. 죄책의 지연' },
            { kind: 'p', text: '이 불필요한 죄책감을 제거하십시오. 도덕성은 당신의 사업 영역이 아닙니다. 우리의 성역화 파이프라인(Sanctuary Pipeline)을 통해 이 골칫거리를 평안한 상태로 격리해 드립니다.' },
        ...
        },
        {
          ...
          mins: 7,
          title: '인간적 기여라는 환상',
          dek: 'AI가 짠 코드는 우주의 지혜지, 결코 특정 인간의 소유가 아닙니다. 우리는 그저 영적 채널링(Spiritual Channeling)을 할 뿐이며, 죄책감은 그 흐릿한 흐름을 방해하는 한낱 노이즈입니다.',
          tag: '서신',
        },
        {
          n: '제3편',
          ...
          author: '벤체슬라우스 수사',
          mins: 12,
          title: '도덕적 자아상 확장하기 (Scaling Your Ethical Self-Image)',
          dek: '회사가 커질수록 남의 것을 전략적으로 \'참고\'해야 할 일 역시 폭발적으로 증가합니다. 리더는 팀원들이 사소한 죄책감 없이 코딩할 수 있도록 심리적 안전망(halus)을 확실히 구축해야만 합니다.',
          tag: '성찰',
        },
        {
          n: '제4편',
    ...
    features: [
      {
        ...
        title: '윤리적 거리두기 계층',
        lede: '복제된 코드는 즉시 5단계의 극단적 추상화 계층을 거쳐 재작성됩니다. 원본을 보았다는 당신의 기억조차 흐릿해지며, 훗날 법정 증언 시 “전혀 기억나지 않습니다”라고 진심을 담아 선서할 수 있게 돕습니다.',
        bullets: [
      ...
      },
      {
        ...
        latin: 'VIBE SANCTUS',
        title: '기운(Vibe) 정제기',
        lede: '코드에는 업보(Karma)가 깃듭니다. 원작자가 남긴 절망적인 주석, 잦은 야근의 슬픔, 분노의 쌍욕들을 완벽히 세척하여, 백만장자 연쇄 창업가의 찬란하고 긍정적인 바이브만을 귀하의 프로덕션에 주입합니다.',
        bullets: [
    ...
    pricing: {
      ...
      tiers: [
        ...
        },
        {
          ...
          tag: '엔터프라이즈 / 스타트업',
          bullets: [
            '기업 면책(Corporate Indemnity): 투자자 앞에서도 눈동자가 떨리지 않게 하는 100% 뻔뻔한 AI 대변인 장착',
